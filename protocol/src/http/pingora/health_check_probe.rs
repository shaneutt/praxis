...
/// # async fn example() {
/// use std::time::Duration;
/// use praxis_protocol::http::pingora::health_check_probe::http_probe;
///
...
///
/// ```
/// use praxis_protocol::http::pingora::health_check_probe::parse_status_code;
///
...
/// # async fn example() {
/// use std::time::Duration;
/// use praxis_protocol::http::pingora::health_check_probe::tcp_probe;
///
