...
/// ```
/// use std::sync::Arc;
/// use praxis_protocol::http::pingora::context::RequestCtx;
///
...
impl RequestCtx {
    ...
    /// };
    /// let mut ctx = RequestCtx::default();
    /// let filter_ctx = ctx.build_filter_context(
    ///     &pipeline,
    ///     &request,
    ///     None,
    /// );
    ...
    /// [`request_snapshot`]: RequestCtx::request_snapshot
    /// [`filter_context_for`]: RequestCtx::filter_context_for
    ...
    ///     headers: http::HeaderMap::new(),
    /// });
    /// let filter_ctx = ctx.filter_context_for(
    ///     &pipeline,
    ///     None,
    /// );
